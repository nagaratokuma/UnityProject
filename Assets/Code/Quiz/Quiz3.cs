...
public class Quiz3 : MonoBehaviourPunCallbacks {
    public static Quiz3 instance;
    ...
    public void PlayAudio(){
        // audioSourceにResourcesの音声をセット
        audioSource.clip = Resources.Load<AudioClip>("Audio/" + HoldValue.QuizNumInt);
        Debug.Log("<color=red>Audio/" + "Audio/" + HoldValue.QuizNumInt + "</color>");
        // 音声を再生
        audioSource.Play();
    }
